...
Message: chore: reorganize repository structure and reconfigure smithery for apex-memory build
Branch: main

---

## Git Commit: chore: reorganize repository structure and reconfigure smith
Source: auto
