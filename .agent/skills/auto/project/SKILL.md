---
name: project
description: "Project for apex-fs-commander. 35 gotchas, 88 conventions, 5 fixes."
domain: project
triggers:
  - glob: "**/*"
autoGenerated: true
...
Auto-compiled from **147 real patterns** in **apex-fs-commander**. This skill is auto-routed to agents when working on project files.
...
| Use Result<T, E> for error handling, not panic! | Use Result<T, E> for error handling, not panic! |
...
| gotcha in .gitignore | File updated (external): .gitignore  Content summary (76 lines): # APEX Security - Never commit thes |
...
These files are imported by many others and repre
